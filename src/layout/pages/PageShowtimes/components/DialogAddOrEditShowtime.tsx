...
// Interface
// import { Movie, MovieInput } from '../../../../interfaces/movie';
...
// interface IDialogAddOrEditMovieProps {
//   movieToEdit: Movie | null, // null: DialogAdd. not null: DialogEdit
//   isOpen: boolean,
...
// const DialogAddOrEditMovie: FunctionComponent<IDialogAddOrEditMovieProps> = (props) => {
//   const [movieInput, setMovieInput] = useState<MovieInput>({ imdbID: '', actors: [], endAt: '', screenTypeIds: [] });
...
//       <DialogTitle id="form-dialog-title">{!props.movieToEdit ? `Add Movie` : `Edit Movie: ${props.movieToEdit.title}`}</DialogTitle>
...
// export default DialogAddOrEditMovie;